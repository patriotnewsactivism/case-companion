...
export default defineConfig(({ mode }) => ({
  ...
  build: {
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          'botframework-vendor': ['botframework-webchat', 'microsoft-cognitiveservices-speech-sdk'],
  ...
  optimizeDeps: {
    include: ['react', 'react-dom', 'react-router-dom', 'botframework-webchat', 'microsoft-cognitiveservices-speech-sdk'],
    exclude: [],
  },
}));
